...
export function AuthProvider({ children }) {
  ...
  const value = useMemo(
    () => ({
      ...
      canDeleteShopFundEntry: canDeleteShopFundEntry(role),
      ...
      canManageShareholderCapital: canManageShareholderCapital(role),
      canChooseInventoryFundSource: canChooseInventoryFundSource(role),
      canManageShareholderReceipts: canManageShareholderReceipts(role),
      canOperateShop: canOperateShop(role),
      canEnterIncome: canEnterIncome(role),
      canDeleteSales: canDeleteSales(role),
      canEditSales: canEditSales(role),
