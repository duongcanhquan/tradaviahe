...
export const ROLE_OPTIONS = [
  {
    ...
    label: "Quản lý",
    description:
      "Toàn quyền quản lý quán + quyền nhân viên (POS thu tiền). Không xem tiền đầu tư / Admin MK",
  },
  {
    value: "employee",
    label: "Nhân viên",
  ...
  },
  {
    ...
    label: "Chủ đầu tư",
    description:
      "Admin + quản lý + nhân viên: toàn hệ thống, vốn đầu tư, xem/reset mật khẩu (trừ Super Admin)",
  },
];
