...
export const ROLE_OPTIONS = [
  {
    ...
    label: "Quản lý",
    description:
      "Kiểm soát dòng tiền quán, nhập hàng hóa/thiết bị, chi tiêu, nhân viên (không xem tiền đầu tư)",
  },
  {
    value: "employee",
    label: "Nhân viên",
  ...
  },
  {
    ...
    label: "Chủ đầu tư",
    description:
      "Xem tiền đầu tư ban đầu, cổ phần, và quản lý toàn bộ hệ thống (trừ Admin MK)",
  },
];
...
/** Bán hàng / nhập thu / xem QR (gồm nhân viên) */
...
/** Chỉ nhập tiền thu (POS) — nhân viên được phép */
 ...
 * Chỉ Chủ đầu tư + Super Admin (Quản lý không thấy).
 */
export function canViewInvestmentCapital(role) {
  return role === "superadmin" || role === "investor";
}

/** Nhập & xem hàng hóa / thiết bị (Quản lý + Chủ ĐT + SA) */
