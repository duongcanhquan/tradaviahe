import { isShopOperatingExpense } from "./expenses";
...
export function calculateMonthlyReport({
  ...
  // Chỉ doanh thu bán hàng trà đá — không gồm dịch vụ XD / nạp quỹ.
  const totalRevenue = transactions
    .filter(isGoodsIncome)
    .reduce((sum, t) => sum + (Number(t.amount) || 0), 0);

  // Chi vận hành quán — không gồm chi XD / chuyển quỹ nội bộ.
